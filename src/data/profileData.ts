...
export const DEFAULT_REPOSITORIES: FeaturedRepository[] = [
  {
    ...
    stars: 12,
    forks: 3,
    topics: ['github-profile', 'typescript', 'react', 'tailwind', 'devops'],
    url: 'https://github.com/asishkashyap/asishkashyap',
    badge: '⭐ Profile Hub',
  },
  {
    name: 'dockerVolumeDocApp',
    description: 'Containerized documentation platform demonstrating Docker persistent volume drivers, container mounts, and web server integration.',
    language: 'HTML',
    languageColor: '#e34c26',
    stars: 3,
    forks: 4,
    topics: ['docker', 'volumes', 'containers', 'devops', 'web-app'],
    url: 'https://github.com/asishkashyap/dockerVolumeDocApp',
    badge: '🐳 Docker & Storage',
  },
  {
    name: 'GitHubActions_Learning',
    description: 'Enterprise CI/CD pipeline automation suite with GitHub Actions, reusable workflows, and automated security linting.',
    language: 'HCL',
    languageColor: '#844fba',
    stars: 2,
    forks: 4,
    topics: ['github-actions', 'ci-cd', 'automation', 'devops', 'workflows'],
    url: 'https://github.com/asishkashyap/GitHubActions_Learning',
    badge: '⚡ CI/CD Automation',
  },
  {
    name: 'terraform_Modules_2026',
    description: 'Production-grade modular Infrastructure as Code (IaC) library for automated multi-environment cloud provisioning.',
    language: 'HCL',
    languageColor: '#844fba',
    stars: 1,
    forks: 1,
    topics: ['terraform', 'iac', 'azure', 'cloud-infrastructure', 'modules'],
    url: 'https://github.com/asishkashyap/terraform_Modules_2026',
    badge: '☁️ Cloud IaC',
  },
  {
    name: 'InfraPipeline',
    description: 'Zero-trust infrastructure delivery pipeline automating Terraform deployments, security compliance scans, and state locking.',
    language: 'HCL',
    languageColor: '#844fba',
    stars: 2,
    forks: 3,
    topics: ['terraform', 'azure-devops', 'security', 'pipelines', 'cloud'],
    url: 'https://github.com/asishkashyap/InfraPipeline',
    badge: '🔐 DevSecOps Pipeline',
  },
  {
    name: 'Kubernetes_secure_approach',
    description: 'Hardened Kubernetes configuration patterns, secrets management integration, and zero-trust container pod security policies.',
    language: 'Dockerfile',
    languageColor: '#384d54',
    stars: 1,
    forks: 1,
    topics: ['kubernetes', 'security', 'docker', 'secrets-management', 'k8s'],
    url: 'https://github.com/asishkashyap/Kubernetes_secure_approach',
